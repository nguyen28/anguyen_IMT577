...
CREATE SECURE VIEW Store_assessment
AS Select
...
LEFT JOIN dim_date ON Fact_salesactual.dimsalesdateid = Dim_DATE.PKEY
WHERE dimstoreID IN (5, 8)
...
WHERE dim_store.dimstoreID IN (5, 8)
